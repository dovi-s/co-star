...
export function registerAudioRoutes(app: Express): void {
  const getSafeTitle = (value: unknown) =>
    typeof value === "string" ? value : "New Chat";
  ...
  app.get("/api/conversations/:id", async (req: Request, res: Response) => {
    try {
      const id = getConversationId(req.params.id);
  ...
  app.post("/api/conversations", async (req: Request, res: Response) => {
    try {
      ...
      const conversation = await chatStorage.createConversation(getSafeTitle(title));
